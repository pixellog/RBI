    ...
    <div class="main">
        <div class="min-vh-100 p-3">
            ...
            <section class="shadow-lg rounded-lg">
                <b-row no-gutters>
                    <b-col cols="10" class="rounded-left position-relative overflow-hidden bg-secondary" style="height: calc(100vh - 90px)">
                        <!-- 지도영역 -->
                    ...
                    <b-col cols="2" class="px-3 pt-3">
                        ...
                        <div class="position-relative">
                            <b-input type="search" class="rounded-lg" @focus="search = true"></b-input>
                            <div class="border p-3 rounded-lg position-absolute w-100 bg-white" style="top: 38px; z-index: 9999" v-if="search">
